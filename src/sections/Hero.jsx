...
import HeroIsometricGrid from '../components/HeroIsometricGrid';
  ...
  return (
    <section 
      style={{
        ...
        paddingTop: 'calc(var(--nav-height) + var(--banner-offset, 0px) + 2.5rem)',
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, width: '100%' }}>
        ...
        >
          ...
          <div className="hero-3d-wrapper" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            >
              <HeroIsometricGrid onStartProject={onStartProject} />
            </motion.div>
          </div>
